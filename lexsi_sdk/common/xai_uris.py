...
GUARDRAILS_DELETE = f"guardrails/delete"
GUARDRAILS_EDIT = f"guardrails/edit"
GUARDRAILS_GET = f"guardrails/get_guardrail"
GUARDRAILS_REMOVE_FROM_MODEL = f"guardrails/remove-from-model"
GUARDRAILS_DUPLICATE = f"guardrails/duplicate"

# Evals Service
CATALOG_URI = f"catalog"
CATALOG_SCORERS_URI = f"catalog/scorers"
CATALOG_ADAPTERS_URI = f"catalog/adapters"
CATALOG_ANNOTATORS_URI = f"catalog/annotators"
CATALOG_GUARD_PROFILES_URI = f"catalog/guard-profiles"
EVALS_RUN_URI = f"evals/run"
EVALS_REJUDGE_URI = f"evals/rejudge"
EVALS_ADD_MODEL_URI = f"evals/add-model"
EVALS_VALIDATE_URI = f"evals/validate"
EVALS_CONFIGS_URI = f"evals/configs"
EVALS_CONFIG_URI = f"evals/config"
RUNS_URI = f"runs"
RUNS_STATUS_URI = f"runs/status"
RUNS_PREDICTIONS_URI = f"runs/predictions"
COMPARE_URI = f"compare"
BENCHMARKS_URI = f"benchmarks"
BENCHMARKS_RUN_URI = f"benchmarks/run"
